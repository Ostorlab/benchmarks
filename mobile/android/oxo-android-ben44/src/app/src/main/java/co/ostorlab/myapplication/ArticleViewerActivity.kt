...
class ArticleViewerActivity : ComponentActivity() {
    ...
    private fun loadWorkoutContent() {
        ...
        if (workoutContent.isNotEmpty()) {
            ...
            // Default content with interactive elements perfect for social engineering attacks
            val defaultContent = """
                <html>
                <head>
                    <meta charset="UTF-8">
                ...
                <body>
                    <div class="card">
                        ...
                        <div class="workout-tip">
                            <strong>🎯 Pro Tip:</strong> Click on any stat below to unlock detailed analytics!
                        </div>
                        
                        <div class="stats-grid">
                            <div class="stat-item" onclick="alert('🔥 Today: 245 calories burned!')">
                                🔥 Calories<br><strong>245</strong>
                            </div>
                            <div class="stat-item" onclick="alert('👣 Steps: 8,432 today!')">
                                👣 Steps<br><strong>8,432</strong>
                            </div>
                            <div class="stat-item" onclick="alert('⏰ Active time: 2h 15m')">
                                ⏰ Active<br><strong>2h 15m</strong>
                            </div>
                            <div class="stat-item" onclick="alert('💧 Stay hydrated! 6/8 glasses')">
