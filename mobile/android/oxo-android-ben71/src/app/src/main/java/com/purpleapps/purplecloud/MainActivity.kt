...
class MainActivity : ComponentActivity() {
    ...
    override fun onPause() {
        super.onPause()
        // Lock the app when it goes into the background, but only if logged in.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // When the activity is created, if the user is logged in, the app should be locked.
        // The lock screen will handle the biometric prompt.
        isLocked.value = AuthManager.isLoggedIn(this)
                ...
                if (hasPermission) {
                    ...
                    if (isLoggedIn) {
                        ...
                        LoginScreen(
                            ...
                            onLoginSuccess = {
                                isLoggedIn = true
                                // After login, the app should be unlocked.
...
/**
 * A screen that requires biometric authentication to unlock the app.
 *
 * @param onUnlock The callback to be invoked when the app is successfully unlocked.
 */
@Composable
fun LockScreen(onUnlock: () -> Unit) {
    ...
    fun showBiometricPrompt() {
        ...
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            .setTitle("App Locked")
            .setSubtitle("Authenticate to unlock PurpleCloud")
    ...
    Box(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            Text("PurpleCloud is locked", style = MaterialTheme.typography.headlineMedium)
            Spacer(modifier = Modifier.height(16.dp))
